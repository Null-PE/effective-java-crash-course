...
public class NutritionFacts_1_TelescopingConstructor {
	...
	// only required
	public NutritionFacts_1_TelescopingConstructor(int servingSize, int servings) {
		this(servingSize, servings, 0, 0, 0, 0);
	}

	// required and optional
	public NutritionFacts_1_TelescopingConstructor(int servingSize, int servings, int calories, int fat, int sodium,
			int carbohydrate) {
